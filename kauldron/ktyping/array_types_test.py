...
def test_is_array_type():
  assert art.is_array_type(art.Array)  # type: ignore
  assert art.is_array_type(art.Float32)  # type: ignore
  assert art.is_array_type(art.Float32["1 2 3"])  # type: ignore
  assert art.is_array_type(art.Float32["1 2 3"])  # type: ignore
  assert not art.is_array_type(int)  # type: ignore
  assert not art.is_array_type(np.float32)  # type: ignore
...
def test_scalar_types():
  ...
  # TODO(klausg): should this still count as a scalar?
