...
def test_multi_host_pad_with_mask_wraps_in_padded_element():
  """Tests that multi-host PAD_WITH_MASK wraps elements in PaddedElement."""
  ...
  for proc_idx in range(4):
    with (
      ...
      ds = kd.data.py.DataSource(
          ...
          num_workers=0,
          batch_size=4,
          batch_drop_remainder=kd.data.py.DropRemainder.PAD_WITH_MASK,
      )
...
def test_multi_host_pad_with_mask_exact_multiple_no_wrapping():
