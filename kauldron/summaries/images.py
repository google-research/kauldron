...
class ImageSummary(metrics.Metric):
  ...
  @struct.dataclass
  class State(metrics.AutoState["ImageSummary"]):
...
class ShowImages(ImageSummary):
  ...
  @struct.dataclass
  class State(ImageSummary.State["ShowImages"]):
    pass
...
class ShowDifferenceImages(ImageSummary):
  ...
  @struct.dataclass
  class State(ImageSummary.State["ShowDifferenceImages"]):
    pass
