...
def checkify_ignore(fn):
  """Decorator to ignore checkify errors.

  The wrapped function will be checkified, but the errors will be ignored.
  This is useful to avoid crashing code that contains checkify user-checks.
  ...
  """
  checked_fn = checkify.checkify(fn)
