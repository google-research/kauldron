...
"""TODO: geco - DO NOT SUBMIT without one-line documentation for knnx.

TODO: geco - DO NOT SUBMIT without a detailed description of knnx.
"""
...
class KdNnxModule(nnx.Module):
  """A wrapper for torch modules to be used in kauldron."""

  # whether we allow the module structure to change during execution.
  __dynamic_module__ = True
...
def _nnx_rngs_from_kd(rngs: dict[str, kd.random.PRNGKey]):
