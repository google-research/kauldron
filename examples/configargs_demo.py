...
class ConfigArgs:
  ...
  dataset_names: str = ("imagenet2012", "coco", "cifar100")
  dataset_weights: tuple[float, ...] = (1.0, 0.5, 1.0)
  dataset_train_split: str = "train"
  dataset_eval_splits: tuple[str, ...] = ("validation", "test")
  batch_size: int = 256


def get_config(args: ConfigArgs = ConfigArgs()) -> kd.train.Trainer:
...
def _make_ds(
    args: ConfigArgs, split: str = "train", training: bool = True
) -> konfig.ConfigDict:
